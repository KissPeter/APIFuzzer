...
from apifuzzer.utils import merge_cli_headers, str2bool
...
def main():
    ...
    parser.add_argument(
        ...
        default=[],
        required=False,
        help="Single header, repeatable. Format: 'Name: Value'",
        dest="header_items",
    )
    parser.add_argument(
        "-v", "--version",
    ...
    try:
        args.headers = merge_cli_headers(args.headers, args.header_items)
    ...
    try:
        ...
        print(
            f"Unexpected exception during fuzz test preparation: "
